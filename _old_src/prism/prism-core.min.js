/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+c+csharp+cpp+csp+csv+django+docker+git+hpkp+ignore+json+makefile+markdown+markup-templating+mongodb+nginx+perl+php+powershell+python+jsx+tsx+regex+ruby+rust+shell-session+sql+typescript+uri+yaml&plugins=line-numbers+autoloader+toolbar+copy-to-clipboard */
