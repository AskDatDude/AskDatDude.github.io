...
id: ICI012AS3A-3001
week:
summary: Tehtävässä murretaan ja korjataan web-sovellusten haavoittuvuuksia, kuten SQL-injektio ja väärät käyttöoikeudet. Lisäksi etsitään piilotettuja hakemistoja ffuf-työkalulla ja osoitetaan korjausten toimivuus.
...
![alt text](assets/SH24/002-01/ffuf_admin_console.png)
...
![alt text](assets/SH24/002-01/admin_console_fix.png)
