...
Lähetään luomaan tiedosto rakennetta ja itse tiedostoja. Tämä on melko suoraviivanen prosessi, koska kaikki samat vaiheet vaan toistetaan, mitä aikasemmin tehtiin ja nyt seurasin vaan Teron nopeita ohjeita, miten rakenne suunilleen menee tässä.
...
Lisäsin omaan versioon vielä sen että vanha symlink otetaan pois käytöstä, jotta ei tule mitään outoja tilanteita, muuten seurattu aika pitkälti Teron pohjaa.
...
#### 3. Ansible Community Documentation: Handlers: running operations on change. Luettavissa: [[https://docs.ansible.com/projects/ansible/latest/playbook_guide/playbooks_handlers.html]] Luettu: 14.4.2026

#### 4. Farhan 2021. The NGINX Handbook – Learn NGINX for Beginners. Luettavissa: [[https://www.freecodecamp.org/news/the-nginx-handbook/]] Luettu: 14.4.2026
